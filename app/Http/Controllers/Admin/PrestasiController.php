...
class PrestasiController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.prestasi.index', compact('prestasi', 'kelas'));
    }
    ...
    {
        $prestasi = Prestasi::with(['siswa.kelas'])->findOrFail($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.prestasi')->with('success', 'Data prestasi berhasil diupdate');
    }
