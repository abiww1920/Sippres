      ...
      <div class="table-responsive">
        <table class="table mb-0 text-nowrap varient-table align-middle fs-3">
          ...
          <tbody>
              ...
              <td>
                <div class="dropdown dropstart">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ route('kesiswaan.pelanggaran.show', $p->id) }}"><i class="ti ti-eye fs-4 me-2"></i>Detail</a></li>
            ...
            @empty
            <tr>
              <td colspan="9" class="text-center py-4"><span class="text-muted">Tidak ada data pelanggaran</span></td>
            </tr>
            @endforelse
          </tbody>
        </table>
    ...
    <div class="modal-content">
      ...
      <form action="{{ route('kesiswaan.pelanggaran.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <select name="guru_pencatat" id="guru_pencatat" class="form-select" required>
          ...
          <div class="mb-3">
            <label class="form-label">Foto Bukti Pelanggaran <span class="text-danger">*</span></label>
...
document.getElementById('jenis_pelanggaran_id').addEventListener('change', function() {
    const poin = this.options[this.selectedIndex].getAttribute('data-poin');
...
function editPelanggaran(id) {
    fetch(`/kesiswaan/pelanggaran/${id}/edit`)
        ...
        .then(data => {
            ...
            document.getElementById('formEditPelanggaran').action = `/kesiswaan/pelanggaran/${id}`;
...
function deletePelanggaran(id) {
    if (confirm('Apakah Anda yakin ingin menghapus data pelanggaran ini?')) {
        ...
        form.method = 'POST';
        form.action = `/kesiswaan/pelanggaran/${id}`;
