...
<div class="container-fluid">
  <div class="mb-4 d-flex justify-content-between align-items-center">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
          <li class="breadcrumb-item">
            <a class="text-muted text-decoration-none" href="{{ route('kesiswaan.dashboard') }}">Home</a>
          </li>
          <li class="breadcrumb-item">
            <a class="text-muted text-decoration-none" href="{{ route('kesiswaan.pelanggaran') }}">Data Pelanggaran</a>
          </li>
    ...
    <div class="d-flex gap-2">
      ...
      <a href="{{ route('kesiswaan.pelanggaran') }}" class="btn btn-primary">
