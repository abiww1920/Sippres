...
<body>
    <div class="header">
        <div class="title">LAPORAN SEMESTER {{ $semester }}</div>
    ...
    <div class="section">
        <div class="section-title">REKAP SEMESTER</div>
        <p><em>Laporan semester akan diimplementasikan dengan data lengkap semester.</em></p>
    </div>
