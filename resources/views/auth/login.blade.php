                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <div class="text-nowrap logo-img text-center d-block py-3 w-100">
                                    <img src="{{ asset('assets/images/logos/logo-saya.png') }}" alt="Logo Sistem Pelanggaran Siswa" style="max-width: 200px; height: auto;" />
                                </div>
                                <p class="text-center">Silakan masuk dengan akun Anda</p>
