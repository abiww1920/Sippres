...
mysql -u root -p -e "CREATE DATABASE IF NOT EXISTS sippres CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"
...
mysql -u root -p sippres < public\sippres.sql
