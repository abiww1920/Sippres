-- ============================================
-- CLEAR DATA LAMA DAN INSERT DATA BARU
-- ============================================
...
TRUNCATE TABLE monitoring_pelanggarans;
TRUNCATE TABLE bimbingan_konselings;
...
-- ============================================
INSERT INTO bimbingan_konselings (id, siswa_id, guru_konselor, topik, tindakan, status, created_at) VALUES
(1, 5, 10, 'Sering ribut di kelas', 'Konseling individu tentang etika di kelas dan dampak ganggu teman', 'selesai', '2024-11-03'),
(2, 10, 10, 'Bolos sekolah', 'Konseling + panggilan ortu, mencari tahu penyebab sering bolos', 'diproses', '2024-11-04'),
(3, 16, 10, 'Berbohong ke guru', 'Konseling tentang kejujuran dan konsekuensi berbohong', 'selesai', '2024-11-05'),
(4, 22, 10, 'Berkelahi', 'Konseling individu + mediasi dengan korban, pembinaan sikap', 'selesai', '2024-11-06'),
(5, 28, 10, 'Merokok di sekolah', 'Konseling intensif tentang bahaya rokok + panggilan ortu', 'diproses', '2024-11-09');

-- ============================================
-- 13. MONITORING PELANGGARAN
-- ============================================
INSERT INTO monitoring_pelanggarans (id, pelanggaran_id, guru_kepsek, catatan, status, created_at) VALUES
(1, 9, 12, 'Kasus berkelahi perlu dimonitor, pastikan tidak terulang', 'dimonitor', '2024-11-06'),
(2, 11, 12, 'Kasus merokok sangat serius, perlu perhatian khusus dan follow up intensif', 'prioritas', '2024-11-08'),
(3, 5, 12, 'Kasus bolos berulang, perlu kerjasama dengan ortu dan BK', 'dimonitor', '2024-11-05');

-- ============================================
-- 14. VERIFIKASI DATA
-- ============================================
INSERT INTO verifikasi_data (id, tabel_terkait, id_terkait, guru_verifikator, status, created_at) VALUES
(1, 'pelanggaran', 1, 9, 'diverifikasi', '2024-11-01 08:00:00'),
(2, 'pelanggaran', 2, 9, 'diverifikasi', '2024-11-02 10:30:00'),
(3, 'pelanggaran', 3, 9, 'diverifikasi', '2024-11-03 09:30:00'),
(4, 'pelanggaran', 5, 9, 'menunggu', '2024-11-04 08:30:00'),
(5, 'prestasi', 1, 9, 'diverifikasi', '2024-10-15 14:00:00'),
(6, 'prestasi', 2, 9, 'diverifikasi', '2024-10-20 15:00:00'),
(7, 'prestasi', 3, 9, 'diverifikasi', '2024-10-10 13:00:00'),
(8, 'prestasi', 6, 9, 'menunggu', '2024-11-01 10:00:00');
